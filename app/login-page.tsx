      ...
      <div className="auth-left">
        <div className="auth-left-inner">
          ...
          <div className="auth-hero">
            ...
            <h2 className="hero-heading">Your finances,<br />clearly in view.</h2>
            <p className="hero-sub">Track spending, monitor income, and hit your goals — all in one beautiful dashboard.</p>
          </div>
      ...
      <div className="auth-right">
        <div className="auth-form-wrapper">
          <div className="auth-form-header">
            ...
            <p className="auth-subtitle">Sign in to your FinSet account</p>
          </div>

          <form className="auth-form" onSubmit={handleLogin} noValidate>
            <div className={`auth-field${focusedField === "email" ? " focused" : ""}${error && !email ? " errored" : ""}`}>
            ...
            <div className={`auth-field${focusedField === "password" ? " focused" : ""}${error && !password ? " errored" : ""}`}>
          ...
          <p className="auth-switch">
            ...
            <Link href="/register" className="auth-link font-semibold">Create one</Link>
          </p>
        </div>
      </div>
    </div>
